...
// Creates a contact in Resend segment with properties + sends welcome email. Direct Resend calls, no Make.
...
export default async function handler(req, res) {
  ...
  try {
    // Step 1: Create contact in Mason Subscribers segment with properties
